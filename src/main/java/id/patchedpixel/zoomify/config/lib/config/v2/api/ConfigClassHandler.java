...
import id.patchedpixel.zoomify.config.lib.config.v2.impl.ConfigClassHandlerImpl;
...
public interface ConfigClassHandler<T> {
     ...
     * They could either be annotated with {@link id.patchedpixel.zoomify.config.lib.config.v2.api.autogen.AutoGen}
