...
import id.patchedpixel.zoomify.config.lib.impl.LabelOptionImpl;
...
/**
 * A label option is an easier way of creating a label with a {@link id.patchedpixel.zoomify.config.lib.gui.controllers.LabelController}.
