...
import id.patchedpixel.zoomify.config.lib.impl.PlaceholderCategoryImpl;
...
public interface PlaceholderCategory extends ConfigCategory {
     ...
     */
    BiFunction<Minecraft, ConfigScreen, Screen> screen();
    ...
    interface Builder {
         ...
         */
        Builder screen(@NotNull BiFunction<Minecraft, ConfigScreen, Screen> screenFunction);
