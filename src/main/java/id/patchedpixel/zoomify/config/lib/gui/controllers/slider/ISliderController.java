package id.patchedpixel.zoomify.config.lib.gui.controllers.slider;
...
public interface ISliderController<T extends Number> extends Controller<T> {
    ...
    /**
     * Sets the {@link id.patchedpixel.zoomify.config.lib.api.Option}'s pending value
     */
    void setPendingValue(double value);

    /**
     * Gets the {@link id.patchedpixel.zoomify.config.lib.api.Option}'s pending value
     */
    double pendingValue();
     ...
     */
    @Override
    default AbstractWidget provideWidget(ConfigScreen screen, Dimension<Integer> widgetDimension) {
