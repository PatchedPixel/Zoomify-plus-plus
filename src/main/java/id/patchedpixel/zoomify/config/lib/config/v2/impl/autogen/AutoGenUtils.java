...
import id.patchedpixel.zoomify.config.lib.api.controller.ValueFormattableController;
...
import id.patchedpixel.zoomify.config.lib.config.v2.api.autogen.CustomFormat;
import id.patchedpixel.zoomify.config.lib.config.v2.api.autogen.FormatTranslation;
