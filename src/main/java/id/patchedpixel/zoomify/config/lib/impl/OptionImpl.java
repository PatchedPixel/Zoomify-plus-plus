...
public class OptionImpl<T> implements Option<T> {
    ...
    public static class BuilderImpl<T> implements Builder<T> {
        ...
        public Builder<T> instant(boolean instant) {
            ...
            ConfigConstants.LOGGER.error("Option.Builder#instant is deprecated behaviour. Please use a custom state manager instead: `.state(StateManager.createInstant(Binding))`");
